    ...
    <>
      {loading ? (
        <>
          ...
          <div className="flex flex-col sm:justify-around md:items-center justify-center items-center sm:items-center">
            <form
              className="w-[90%] sm:w-[75vw] flex flex-col md:flex-row  md:justify-evenly md:gap-x-20 lg:justify-evenly md:items-center md:h-[65vh] gap-y-7 md:mt-20 mt-20 sm:mt-[15px]"
              onSubmit={handleSubmit}
            >
              <div className="lg:w-[35%] flex flex-col justify-center gap-y-7 md:gap-y-[40px] lg:gap-y-[50px] mt-[20px]">
                <h1 className="font-[700] text-[40px] md:text-3xl text-[#6889FF] ">
                  Tambah Wisata
                </h1>
                <Input
                  type="text"
              ...
              <div className="flex flex-col justify-around gap-y-8 md:mt-[200px] lg:mt-[200px]">
                ...
                <label
                  tabIndex={0}
                  htmlFor="tambah"
                  className="flex justify-center items-center cursor-pointer h-[40vh] sm:h-[50vh] md:h-[230px] md:my-1 md:w-[35vw] w-full lg:h-[260px] rounded-xl bg-[#F6F6F6]"
                >
                  <div className="flex flex-col justify-center items-center opacity-100">
                    {img ? (
                      <>
                        <img
                          src={img}
                          className="w-[100vw] h-[40vh] sm:h-[50vh] md:w-[35vw] md:h-[230px] lg:h-[260px] rounded-md"
                        />
                        <input
                          id="tambah"
                          type="file"
                      ...
                      <>
                        <img
                          className="w-[53px] md:w-[63px] sm:mt-5 md:mt-5"
                          src={uploadIcon}
                        />
                        <input
                          id="tambah"
                          ...
                          onChange={handleInputImg}
                        />
                        <p className="text-md py-5 md:pt-10">
                          Tambah Gambar
                        </p>
                      </>
                    )}
                ...
                <div className="flex justify-center mb-5">
                  <Button
                    className="w-full md:w-[27vw] py-[15px] lg:py-3"
        ...
        <>
          <nav className="fixed top-0 flex justify-between items-center bg-white px-5 h-[65px] w-full shadow-[3px__3px_3px_0px_rgba(0,0,0,0.35)] z-10 sm:hidden">
            ...
            {showName ? (
              !loading ? (
                <h1 className="font-[700] text-xl capitalize">
                  Hai, {userName}!
                </h1>
              ) : (
